...
if /I "%compiler%"=="clang" set "common_flags= -I../src/ -DOS_WINDOWS=1 -DCOMPILER_CLANG=1 -Wall -std=c23 -Wno-unused-function -Wno-missing-braces -Wmissing-field-initializers -Wno-macro-redefined"
if /I "%compiler%"=="msvc" set "common_flags= /I../src/ /DOS_WINDOWS=1 /DCOMPILER_MSVC=1 /W3 /nologo /std:clatest /Zc:preprocessor"
...
%compile_cmd% %common_flags% ..\src\main.c %compile_link% %out%emulator.exe
